...
class Ammeter(TelnetDevice, Device):
        ...
        match data_key:
            case Ammeter.DataKeys.CURRENT:
                try:
                    ...
                    _log.error(
                        "Timeout occurred while waiting for a valid numeric response from the ammeter."
                    )
    ...
    async def _handshake(self) -> None:
        ...
        _log.info(f"Successfully connected to Ammeter: {response}.")
        return
    ...
    async def _setup(self) -> None:
        ...
        setup_commands = [
            Ammeter.Commands.CURRENT_FUNCTION,
